! -------------------------------------------------------------------------------------
! binarize takes a stack of 2D spider images (stk) and applies a low pass filter with 
! low pass limit (lp), binarizes using a threshold intensity (tres), and sets pixels 
! beyond a mask radius (msk) from the center to the background intensity. 
! 
! Command Arguments:
...
!     that you are imaging and want to ignore anything beyond a radius around the center)
